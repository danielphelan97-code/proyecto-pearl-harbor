...
const WIKI_SPECS = {
    ...
    "Clase Gorshkov Mod.": { displacement: "45,400 tons", length: "284 m", propulsion: "8x Calderas de Vapor Presurizadas", airWing: "Aprox. 36 aeronaves (26× cazas MiG-29K/KUB, 10× helicópteros Kamov Ka-31, Ka-28)", radar: "Podberezovik 3D, Fregat-M2EM", weapons: "Sistemas de Defensa Aérea Barak 8 (LRSAM), 4× AK-630 CIWS de fabricación rusa" },
    "Clase Kuznetsov Mod.": { 
    ...
    "Porta-Drones (Turquía)": { 
        displacement: "27,436 tons", length: "231 m", propulsion: "5x Motores Diésel (Navantia/MAN)", 
    ...
    "Multiproposito (Brasil)": { 
        displacement: "21,500 tons", length: "203.4 m", propulsion: "2x Diésel Pielstick, 2x Alternadores Alstom", 
    ...
    "Portaaviones (Tailandia)": { 
        displacement: "11,486 tons", length: "182.6 m", propulsion: "CODOG (2x Turbinas LM2500, 2x Motores Diésel)", 
    ...
    "Type 001": { displacement: "60,000 tons", length: "304.5 m", propulsion: "Calderas de Vapor", airWing: "Aprox. 24-40 cazas J-15 Flying Shark, helicópteros Z-18 AEW", radar: "Tipo 346 S-Band AESA", weapons: "3× HQ-10 SAM, 3× Tipo 1130 CIWS 30mm" },
    "Type 002": { displacement: "65,000 tons", length: "315 m", propulsion: "Calderas de Vapor Chinas", airWing: "Aprox. 44-50 aeronaves: 32× cazas J-15, helicópteros Z-18", radar: "Tipo 346A S-Band AESA avanzado", weapons: "3× Tipo 1130 CIWS, 3× HQ-10 SAM" },
    "Type 003": { displacement: "80,000+ tons", length: "316 m", propulsion: "EMALS catapultas, propulsión convencional", airWing: "60+ aeronaves: J-15T, J-35 furtivo, KJ-600 AEW", radar: "AESA Multipropósito integrado", weapons: "HQ-10 SAM y múltiples CIWS Tipo 1130" },
    "Clase Queen Elizabeth": { displacement: "65,000 tons", length: "284 m", propulsion: "IFEP (2x Rolls-Royce MT30, 4x Wärtsilä Diésel)", airWing: "36× F-35B Lightning II, helicópteros Merlin HM2, Wildcat AH1", radar: "S1850M 3D, Artisan 3D Tipo 997", weapons: "3× Phalanx CIWS, 4× cañones DS30M 30mm" },
    "Clase Charles de Gaulle": { displacement: "42,500 tons", length: "261.5 m", propulsion: "2× Reactores Nucleares Areva K15", airWing: "40 aeronaves: Rafale M, E-2C Hawkeye, NH90 Caïman", radar: "Thales Arabel 3D, J11 long-range", weapons: "32× Sylver A43 (Aster 15), 2× Sadral (Mistral)" },
    "Clase Cavour": { displacement: "27,000 tons", length: "244 m", propulsion: "COGAG (4× LM2500 GE)", airWing: "20-30 aeronaves: F-35B, Harrier AV-8B+, EH-101 Merlin, NH90", radar: "Leonardo Kronos Naval, Selex RAN-40L", weapons: "32× Sylver A43 (Aster 15), 2× OTO Melara 76mm, 3× CIWS 25mm" },
    "Clase Garibaldi": { displacement: "13,850 tons", length: "180 m", propulsion: "COGAG (4× LM2500 GE)", airWing: "18 aeronaves: Harrier AV-8B+, AW101, NHIndustries NH90", radar: "MM/SPS-768 RAN 3L, SPS-774", weapons: "2× Aspide SAM, 3× Dardo CIWS 40mm, tubos lanzatorpedos 324mm" },
    "Clase Juan Carlos I": { displacement: "26,000 tons", length: "230.8 m", propulsion: "CODLAG (1× LM2500 GT, 2× motores Diésel)", airWing: "30 aeronaves: Harrier AV-8B+ Matador, NH90, SH-60B Seahawk", radar: "Selex RAN-40L 3D, Lanza-N", weapons: "4× cañones 20mm, ametralladoras M2 pesadas" },
};;

console.log('--- OSINT INTEL v7.0 DEFINITIVE LOADED ---');
const CARRIERS = [
    ...
    { id: "cvn72", name: "USS Abraham Lincoln", hull: "CVN-72", cls: "Clase Nimitz (EE.UU.)", country: "EE.UU.", photo: "https://upload.wikimedia.org/wikipedia/commons/b/ba/USS_Abraham_Lincoln_%28CVN-72%29_transits_the_Pacific_Ocean%2C_13_August_2022_%28220813-N-N1809-002%29.jpg", launched: "13 Feb 1988", commissioned: "11 Nov 1989", history: [
        ...
        { date: "2025-05-12", ...LOCATIONS.persian_gulf, status: "Desplegado", op: "Guerra de Irán (Epic Fury)", desc: "Participación activa en misiones de supresión de defensas aéreas (SEAD). Sus F/A-18E neutralizaron baterías costeras en la Isla de Qeshm.", sources: [{ name: "OSINT Tactical Reports", url: "#" }] },
        { date: "2025-09-10", ...LOCATIONS.san_diego, status: "En Puerto", op: "Retorno de Combate", desc: "Arribo a San Diego tras 14 meses de despliegue batiendo récords de permanencia en zona de guerra.", sources: [{ name: "Pacific Fleet PAO", url: "#" }] },
    ...
    { id: "cvn78", name: "USS Gerald R. Ford", hull: "CVN-78", cls: "Clase Ford (EE.UU.)", country: "EE.UU.", photo: "https://upload.wikimedia.org/wikipedia/commons/5/53/USS_Gerald_R._Ford_%28CVN-78%29_underway_in_the_Atlantic_Ocean_on_8_April_2017.JPG", launched: "2013-10-11", commissioned: "2017-07-22", history: [
        ...
        { date: "2025-01-10", ...LOCATIONS.caribbean_sea, status: "Desplegado", op: "Crisis de Caracas / Maduro", desc: "Bloqueo aeronaval total sobre La Guaira. Participación protagónica en la inserción de fuerzas especiales para la captura de Nicolás Maduro.", sources: [{ name: "Intelligence Briefing", url: "#" }] },
        { date: "2025-06-15", ...LOCATIONS.bab_el_mandeb, status: "Desplegado", op: "Campaña de Yemen (Retribution)", desc: "Operaciones relámpago en el Mar Rojo; neutralización de enjambres de drones merodeadores lanzados desde Hodeida.", sources: [{ name: "CENTCOM", url: "#" }] },
        { date: "2025-10-22", ...LOCATIONS.persian_gulf, status: "Desplegado", op: "Guerra de Irán (Epic Fury)", desc: "Lideró el asalto aeronaval masivo. Sus F-35C del VFA-147 realizaron las primeras misiones de combate real sobre Teherán.", sources: [{ name: "OSINT War Journal", url: "#" }] },
    ...
    { id: "pow9", name: "HMS Prince of Wales", hull: "R09", cls: "Royal Navy (Reino Unido)", country: "Reino Unido", photo: "https://upload.wikimedia.org/wikipedia/commons/1/1d/HMS_Prince_of_Wales_in_the_North_Sea_%2849887823576%29.jpg", launched: "21 Dec 2017", commissioned: "10 Dec 2019", history: [
        ...
        { date: "2026-03-24", ...LOCATIONS.portsmouth, status: "En Puerto", op: "5-Day Readiness", desc: "En Portsmouth con alerta de zarpada reducida a 5 días; preparativos de logística para Op. Firecrest.", sources: [{ name: "Royal Navy PAO", url: "#" }] }
    ]},
    { id: "jci61", name: "Juan Carlos I", hull: "L61", cls: "Armada Española", country: "España", photo: "https://upload.wikimedia.org/wikipedia/commons/b/bd/L_61_Juan_Carlos_I_arriving_to_Istanbul_-_Bosphorus.jpg", launched: "2008-03-10", commissioned: "2010-09-30", history: [
        ...
        { date: "2021-05-20", ...LOCATIONS.atlantic_north, status: "Desplegado", op: "Steadfast Defender 21", desc: "Escoltado por fragatas AEGIS F-100 protegiendo las líneas atlánticas aliadas.", sources: [{ name: "Defensa.com", url: "#" }] },
        { date: "2022-06-18", ...LOCATIONS.med_sea, status: "Desplegado", op: "Grupo Dédalo / FLOTEX", desc: "Despliegue operativo anfibio a lo largo del Mare Nostrum.", sources: [{ name: "Revista Ejércitos", url: "#" }] },
    ...
    { id: "cvn75", name: "USS Harry S. Truman", hull: "CVN-75", cls: "Clase Nimitz (EE.UU.)", country: "EE.UU.", photo: "https://upload.wikimedia.org/wikipedia/commons/1/15/USS_Harry_S._Truman_%28CVN-75%29_underway_in_the_Mediterranean_Sea_on_2_February_2022_%28220202-N-N1809-002%29.jpg", launched: "7 Sep 1996", commissioned: "25 Jul 1998", history: [
        ...
        { date: "2022-02-24", ...LOCATIONS.med_sea_central, status: "Desplegado", op: "Guerra en Ucrania", desc: "Orden de máxima alerta operando frenétricamente bajo jurisdicción europea tras la invasión rusa de Ucrania.", sources: [{ name: "NATO MARCOM", url: "https://mc.nato.int/" }] },
        ...
        { date: "2024-09-23", ...LOCATIONS.norfolk, status: "En Puerto", op: "Pre-RCOH Norfolk", desc: "Atracado en Norfolk iniciando las fases de descarga de munición previo a su ingreso en Newport News.", sources: [{ name: "Naval Sea Systems", url: "#" }] },
        { date: "2026-03-24", ...LOCATIONS.norfolk, status: "En Puerto", op: "Alistamiento Dique", desc: "Atracado en Norfolk; el grupo aéreo ha sido desembarcado antes del inicio del refit de media vida.", sources: [{ name: "USNI News", url: "#" }] }
    ]},
    ...
    { id: "garibaldi", name: "ITS Giuseppe Garibaldi", hull: "C 551", cls: "Clase Garibaldi (Marina Militare)", country: "Italia", photo: "https://upload.wikimedia.org/wikipedia/commons/e/ea/ITS_Giuseppe_Garibaldi_%28C_551%29_underway_in_the_Mediterranean_Sea_in_May_2004.jpg", launched: "4 Jun 1983", commissioned: "30 Sep 1985", history: [
        ...
        { date: "2026-03-24", ...LOCATIONS.taranto, status: "En Puerto", op: "Transferencia Indonesia", desc: "En proceso de donación a Indonesia para misiones humanitarias; llegada prevista antes de octubre 2026.", sources: [{ name: "Naval News", url: "#" }] }
    ]},
    ...
    { id: "kuznetsov", country: "Rusia", name: "Admiral Kuznetsov", hull: "063", cls: "Clase Kuznetsov (VMF)", photo: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Admiral_Kuznetsov_carrier.jpg", launched: "1985-12-04", commissioned: "1991-01-20", history: [
        { date: "2020-01-01", ...LOCATIONS.murmansk, status: "Mantenimiento", op: "Overhaul Crítico", desc: "Sometido a reparaciones tras incendios y fallos de dique seco.", sources: [{ name: "TASS", url: "#" }] },
        { date: "2024-05-10", ...LOCATIONS.murmansk, status: "Mantenimiento", op: "Astillero 35", desc: "Pruebas de calderas en puerto; se reportan humos negros densos.", sources: [{ name: "Sputnik", url: "#" }] },
        { date: "2026-03-24", ...LOCATIONS.murmansk, status: "Mantenimiento", op: "Reactividad Limitada", desc: "Permanece en Múrmansk con dotación reducida; salida postergada indefinidamente.", sources: [{ name: "OSINT", url: "#" }] }
    ]},
    { id: "vikramaditya", name: "INS Vikramaditya", hull: "R33", cls: "Clase Gorshkov Mod.", country: "India", photo: "https://upload.wikimedia.org/wikipedia/commons/0/05/INS_Vikramaditya_at_sea.jpg", launched: "1982-03-31", commissioned: "2013-11-16", history: [
        { date: "2024-01-02", ...LOCATIONS.karwar, status: "Desplegado", op: "Escuadra Oeste", desc: "Operando como el núcleo de la fuerza de ataque india en el Mar Arábigo.", sources: [{ name: "Indian Navy", url: "#" }] },
        { date: "2026-03-24", ...LOCATIONS.karwar, status: "En Puerto", op: "Guarnición Activa", desc: "Fondeado en Karwar protegiendo el flanco occidental.", sources: [{ name: "OSINT IND", url: "#" }] }
    ]},
